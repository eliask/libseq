...
public:
   ...
   virtual ~DigitalSequence_classic();
            DigitalSequence_classic(C_matrix *, Rng * rng);
            DigitalSequence_classic(C_matrix *, UL_int, Rng * rng);
            DigitalSequence_classic(C_matrix *, UL_int, UL_int, Rng * rng);
};
...
public: 
   ...
   virtual ~DigitalSequence_medium_base();
            DigitalSequence_medium_base(C_matrix *, Rng *);
            DigitalSequence_medium_base(C_matrix *, UL_int, Rng *);
            DigitalSequence_medium_base(C_matrix *, UL_int, UL_int, Rng *);
};
...
public: 
   ...
   virtual ~DigitalSequence_advanced();
            DigitalSequence_advanced(C_matrix *, Rng *);
            DigitalSequence_advanced(C_matrix *, UL_int, Rng *);
            DigitalSequence_advanced(C_matrix *, UL_int, UL_int, Rng *);
};
...
public:
   ...
   virtual ~DigitalSequence_base_2();
            DigitalSequence_base_2(C_matrix *, Rng *);
            DigitalSequence_base_2(C_matrix *, UL_int, Rng *);
            DigitalSequence_base_2(C_matrix *, UL_int, UL_int, Rng *);
};
