/////////////////////////////////////////////////////////////////////////////
//                                                                         
// Permutation.cpp, 8.8.99, Ilja Friedel                       
//
/////////////////////////////////////////////////////////////////////////////
//                                                                         
...
R_Elem Permutation::operator[](const UL_int j)
       ...
       if(j>=base)
	 {
	   ...
	   if(this==NULL) 
	     cerr << "(Call to a not allocated permutation! [this==NULL])"
		  <<endl;
	   else cerr << "[this!=NULL]" << endl;
	   exit(1);
	  }
#endif
       return(X[j]);
...
void RandomPermutation::operator++(void)
{
   ...
   for(i=(L_int)base-1;i>=1;i--)
     {
       pos=(L_int)random_Ring_Element(i+1, rng);
...
/////////////////////////////////////////////////////////////////////////////
	 ...
	 {
    	   pos    = i+(L_int)random_Ring_Element(base-i+1,rng);
