//////////////////////////////////////////////////////////////////////////////
//
// DigitalSequence_base_2.cpp, Ilja Friedel, 1.8.99
//
//////////////////////////////////////////////////////////////////////////////
//
...
DigitalSequence_base_2::DigitalSequence_base_2(C_matrix *C, Rng *rng_ptr) :DigitalSequence(C->dimension, rng_ptr)
{
   init(C,0);
}
...
DigitalSequence_base_2::DigitalSequence_base_2(C_matrix *C, 
					       UL_int dimension, Rng * rng_ptr) :DigitalSequence(dimension,rng_ptr)
{
  init(C,0);
}
...
DigitalSequence_base_2::DigitalSequence_base_2(C_matrix *C, 
					       UL_int dimension, 
					       UL_int offset,
					       Rng * rng_ptr) :DigitalSequence(dimension,rng_ptr)
{
   init(C,offset);
}
...
void DigitalSequence_base_2::random_restart()
{
   int i;
