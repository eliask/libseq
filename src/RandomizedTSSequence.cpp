//////////////////////////////////////////////////////////////////////////////
//
// RandomizedTSSequence.cpp, 8.8.99, Ilja Friedel
//
//////////////////////////////////////////////////////////////////////////////
//
...
RandomizedTSSequence * new_RandomizedTSSequence(C_matrix *C, UL_int len, Rng * rng_ptr)
{
   if(C->R->base==2) return (new RandomizedTSSequence_base_2(C,len,rng_ptr));
   else
     {
       return (new RandomizedTSSequence(C,len,rng_ptr));
     }
}

//////////////////////////////////////////////////////////////////////////////

RandomizedTSSequence * new_RandomizedTSSequence(C_matrix *C, UL_int dim, UL_int len, Rng * rng_ptr)
{
   if(C->R->base==2) return (new RandomizedTSSequence_base_2(C,dim,len,rng_ptr));
   else
     {
       return (new RandomizedTSSequence(C,dim,len,rng_ptr));
     }
}

//////////////////////////////////////////////////////////////////////////////

RandomizedTSSequence * new_RandomizedTSSequence(C_matrix *C, UL_int dim, UL_int len, UL_int LSS_flag, Rng * rng_ptr)
{
   if(C->R->base==2) return (new RandomizedTSSequence_base_2(C,len,dim,LSS_flag,rng_ptr));
   else
     {
       return (new RandomizedTSSequence(C,len,dim,LSS_flag,rng_ptr));
     }
}
...
RandomizedTSSequence::RandomizedTSSequence(C_matrix * C, UL_int len, Rng * rng_ptr):Sequence(C->dimension,rng_ptr)
{
...
RandomizedTSSequence::RandomizedTSSequence(C_matrix * C, UL_int dim, UL_int len, Rng * rng_ptr):Sequence(dim,rng_ptr)
{
   init(C,dim,len,0);
}
...
RandomizedTSSequence::RandomizedTSSequence(C_matrix * C, UL_int dim, UL_int len, UL_int LSS_flag, Rng * rng_ptr):Sequence(dim,rng_ptr)
{
   ...
   for(i=1;i<=NumDigits;i++)
     {
       ...
       Perm  [i]=new RandomPermutation(base, rng);
       if(!(Perm[i]))
	 {
...
//////////////////////////////////////////////////////////////////////////////
   if(base==2)
     {
       GEN=new DigitalSequence_base_2(C,dimension,rng);
     }
   else
     {
#ifdef DEBUG
       ...
       GEN=new DigitalSequence_classic(C,dimension,rng);
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
       ...
       GEN=new DigitalSequence_advanced(C,dimension,rng);
#endif
     }
...
//////////////////////////////////////////////////////////////////////////////
	       ...
	       if(CD<NextCD)
		 {
		   ...
		   cout << "[07]";
#endif
		   value=(value+dist(*rng))*powers[digits[0]-NextCD];
		 }
	       else
		 {
#ifdef RTSS_TEST
		   cout << "[48]";
#endif
		   value=(value+dist(*rng))*powers[digits[0]-CD];
		 }
...
//////////////////////////////////////////////////////////////////////////////
	 ...
	 {
	   pos=random_Ring_Element(i+1,rng);
...
void RandomizedTSSequence::random_restart()
{
   randomize_sequence();
   n=0;
   n--;
