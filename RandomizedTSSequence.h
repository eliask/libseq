...
public: 
   virtual         ~RandomizedTSSequence();
                    RandomizedTSSequence(UL_int dim, Rng * rng):Sequence(dim, rng)
		      {
			Perm[1]=NULL;
		      }
		    // just forwarding dimension to Sequence for RTSS_base_2
                    RandomizedTSSequence(C_matrix *, UL_int len, Rng *);
                    RandomizedTSSequence(C_matrix *, UL_int, UL_int, Rng *);
                    RandomizedTSSequence(C_matrix *, UL_int, UL_int, UL_int, Rng *);

   virtual void     operator++(void);
   virtual void     random_restart();
...
public: 
                RandomizedTSSequence_base_2(C_matrix *, UL_int len, Rng * rng_ptr);
                RandomizedTSSequence_base_2(C_matrix *, UL_int dim, UL_int len, Rng * rng_ptr);
                RandomizedTSSequence_base_2(C_matrix *, UL_int, UL_int, UL_int, Rng * rng_ptr);
           void random_restart();
};
